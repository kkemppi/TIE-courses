...
public:
  ...
  /*!
   * \brief print prints the date to the stream given as a parameter (like cout)
   * \param printStream to be printed to
   * \pre -
   */
  void print(std::ostream* printStream) const;

  static unsigned int const months[12]; //!< Array for the lenghts of the months
